...
def main_worker(gpu, ngpus_per_node, args):
    ...
    if args.fine_tuning:
        ...
        if args.arch.find('alexnet') != -1:
            ...
            # model.last_linear = nn.Linear(inchannel, 5)
    ...
    criterion = nn.CrossEntropyLoss(weight=torch.Tensor([3, 5, 3, 1, 1])).cuda(args.gpu)  #  ok
    # use_cuda = True
    ...
    if args.arch.find('alexnet') != -1:
        ...
        fine_tune_parameters = model.module.classif.parameters()
    elif args.arch.find('RepVGG_A1') != -1:
